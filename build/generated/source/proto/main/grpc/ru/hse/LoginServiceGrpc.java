...
public final class LoginServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.hse.Services.LoginRequest,
      ru.hse.Services.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = ru.hse.Services.LoginRequest.class,
      responseType = ru.hse.Services.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.hse.Services.LoginRequest,
      ru.hse.Services.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<ru.hse.Services.LoginRequest, ru.hse.Services.LoginResponse> getLoginMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLoginMethod = LoginServiceGrpc.getLoginMethod) == null) {
          LoginServiceGrpc.getLoginMethod = getLoginMethod =
              io.grpc.MethodDescriptor.<ru.hse.Services.LoginRequest, ru.hse.Services.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.hse.Services.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.hse.Services.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(ru.hse.Services.LoginRequest request,
        io.grpc.stub.StreamObserver<ru.hse.Services.LoginResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ru.hse.Services.LoginRequest,
                ru.hse.Services.LoginResponse>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public ru.hse.Services.LoginResponse login(ru.hse.Services.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.hse.Services.LoginResponse> login(
        ru.hse.Services.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((ru.hse.Services.LoginRequest) request,
              (io.grpc.stub.StreamObserver<ru.hse.Services.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.hse.Services.getDescriptor();
    }
